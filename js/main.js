...
Vue.component('creator', {
    ...
    methods:{
        ...
        copyCard(){
            ...
            copy.reasonsRefund = [...this.blank.reasonsRefund];
            return copy;
        }
    },
    mounted(){
...
Vue.component('card', {
    ...
    template:
        ...
        <div :class="{'card-space' : !exampleCard.overdueFlag, 'red-card-space' : exampleCard.overdueFlag}">
            ...
            <p v-if="exampleCard.reasonsRefund.length && !showReasonRefundFlag">
                <b>Причины возврата: </b>
                <ul>
                    <li v-for="(reason, index) in exampleCard.reasonsRefund" :key="index">{{ reason }}</li></hr>
                </ul>
            </p>
